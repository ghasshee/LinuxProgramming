...
#define fp(str) fprintf(stderr, "               " str)
    fp("b - MS_BIND         create a bind mount                    \n");
    fp("d - MS_DIRSYNC      synchronous directory updates          \n");
    fp("l - MS_MANDLOCK     permit mandatory locking               \n");
    fp("m - MS_MOVE         automatically move the mounted subtree \n");
    fp("A - MS_NOATIME      don't update atime (last access time)  \n");
    fp("V - MS_NODEV        don't permit devvice access            \n");
    fp("D - MS_NODIRATIME   don't update atime on directories      \n");
    fp("E - MS_NOEXEC       don't allow executables                \n");
    fp("S - MS_NOSUID       disable set-user/group-ID programs     \n");
    fp("r - MS_RDONLY       read-only mount                        \n");
    fp("c - MS_REC          recursive mount                        \n");
    fp("R - MS_REMOUNT      remount                                \n");
    fp("s - MS_SYNCHRONOUS  make writes synchronous                \n");
    exit(EXIT_FAILURE); 
}
